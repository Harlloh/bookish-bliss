      ...
      <section className="bg-gradient-to-b from-parchment to-cream py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="mt-6 text-lg text-muted max-w-2xl mx-auto">
            Join our community of book lovers. Share reviews, discover hidden
            gems, and build your reading list.
          </p>
      ...
      <section className="py-16 bg-parchment/50">
        <div className="max-w-6xl mx-auto px-4">
          ...
          {isDashboardLoading ? (
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {dashBoardData?.topRatedBooks?.length > 0 ? (
                dashBoardData?.topRatedBooks?.map((book) => (
                  <BookCard key={book.id} book={book} />
                ))
              ) : (
